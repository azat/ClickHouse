...
{
#if defined(OS_LINUX)
    if (read_context && !read_context->isCancelled() && !read_context->isFinished())
    {
        LOG_FATAL(log, "Read context was neither cancelled nor finished. This is a bug");
        abort();
    }
#endif
