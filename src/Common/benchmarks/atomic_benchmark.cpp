...
BENCHMARK(BM_atomic_store_release);
...
BENCHMARK(BM_atomic_store_seq_cst);
...
BENCHMARK(BM_atomic_fetch_add_seq_cst);
...
BENCHMARK(BM_atomic_acquire_fence);
...
BENCHMARK(BM_atomic_seq_cst_fence);
...
BENCHMARK(BM_atomic_fetch_add_cs);
