...
void Connection::sendMergeTreeIndexAnalysisResponse(const IndexAnalysisResponse & response)
{
...
IndexAnalysisRequest Connection::receiveParallelReplicasIndexAnalysis() const
{
    return IndexAnalysisRequest::deserialize(*in, server_parallel_replicas_protocol_version);
}
