...
public:
    ...
    void sendMergeTreeIndexAnalysisResponse(const ParallelReplicasIndexAnalysisResponse & response) override;
...
private:
    ...
    ParallelReplicasIndexAnalysisRequest receiveParallelReplicasIndexAnalysis() const;
